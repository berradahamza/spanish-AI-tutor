    ...
    <div class="w-full max-w-md h-full bg-white flex flex-col shadow-xl relative">
      ...
      <main class="flex-1 overflow-y-auto px-6 pb-6 -mt-16 space-y-5 sagrada-light-bg no-scrollbar z-20 pt-2">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <router-link to="/story-setup" class="bg-white p-5 rounded-3xl shadow-lg border border-white/50 flex flex-col items-center text-center gap-3 card-hover transition hover:shadow-xl cursor-pointer">
                <div class="w-14 h-14 organic-shape bg-indigo-50 flex items-center justify-center text-indigo-600 mb-1 shadow-sm">
                    <i class="fa-solid fa-book-journal-whills text-2xl"></i>
                </div>
                <div><h3 class="font-bold text-gray-800">Mon Histoire</h3></div>
            </router-link>

            <router-link to="/conjugation" class="bg-white p-5 rounded-3xl shadow-lg border border-white/50 flex flex-col items-center text-center gap-3 card-hover transition hover:shadow-xl cursor-pointer">
                <div class="w-14 h-14 organic-shape bg-violet-50 flex items-center justify-center text-violet-500 mb-1 shadow-sm">
                    <i class="fa-solid fa-layer-group text-2xl"></i>
                </div>
                <div><h3 class="font-bold text-gray-800">Conjugaison</h3></div>
            </router-link>
        </div>
